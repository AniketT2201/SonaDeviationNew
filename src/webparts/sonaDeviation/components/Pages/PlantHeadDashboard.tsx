...
export const PlantHeadDashboard: React.FC<ISonaDeviationProps> = (props: ISonaDeviationProps) => {
    ...
    const GetListData = async () => {
        ...
        const data = parentItems.filter((item: any) => {
            ...
            const plantHeadStep = matrix.find(
                (m: any) => m.Role === "PlantHead" && m.required === true
            );

            return plantHeadStep?.Stage === item.Stage;
        });
        setListData(data);
