...
export const QualityDashboard: React.FC<ISonaDeviationProps> = (props: ISonaDeviationProps) => {
    ...
    const GetListData = async () => {
        ...
        const data = parentItems.filter((item: any) => {
            ...
            const qualityStep = matrix.find(
                (m: any) => m.Role === "Quality" && m.required === true
            );

            return qualityStep?.Stage === item.Stage;
        });
        setListData(data);
